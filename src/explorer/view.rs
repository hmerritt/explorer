...
use crate::explorer::{
    ...
    download::{ActiveRemoteDownload, DownloadNoticeRow, YtDlpProcessControl},
...
pub struct ExplorerView {
    ...
    pub(super) download_batch_active: bool,
...
impl ExplorerView {
    ...
    fn new_unloaded_inner_with_settings(
        ...
        Self {
            ...
            ytdlp_process_controls: Vec::new(),
...
mod tests {
    ...
    #[gpui::test]
    fn apply_settings_hides_google_drive_and_rebuilds_sidebar(cx: &mut gpui::TestAppContext) {
        let (view, cx) = cx.add_window_view(|window, cx| {
            let focus_handle = cx.focus_handle();
            focus_handle.focus(window);
            let mut view = ExplorerView::new_with_focus_handle_for_test(
        ...
        cx.update(|_, app| {
            view.update(app, |view, cx| {
                view.apply_settings(
                    &ExplorerSettings {
                        sidebar: crate::settings::SidebarSettings {
                            hide_items: vec![crate::settings::SidebarHiddenItem::GoogleDrive],
                            ..crate::settings::SidebarSettings::default()
                        },
                        ..ExplorerSettings::default()
                    },
        ...
        cx.read_entity(&view, |view, _| {
            assert_eq!(
                ...
                vec![crate::settings::SidebarHiddenItem::GoogleDrive]
            );
            assert!(
                view.sidebar_sections
                    .network_drives
