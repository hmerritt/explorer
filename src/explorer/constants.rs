...
pub(super) const DIRECTORY_BAR_COPY_BUTTON_SIZE: f32 = 28.0;
pub(super) const DIRECTORY_BAR_COPY_BUTTON_GAP: f32 = 6.0;
...
pub(crate) const STATUS_BAR_HORIZONTAL_PADDING: f32 = 16.0;
pub(crate) const STATUS_BAR_TEXT_SIZE: f32 = 12.0;
pub(crate) const STATUS_BAR_TEXT_COLOR: u32 = 0x595959;
pub(crate) const STATUS_BAR_SEPARATOR_COLOR: u32 = 0xe5e5e5;
...
pub(crate) const SCROLLBAR_GUTTER_WIDTH: f32 = 18.0;
pub(crate) const SCROLLBAR_THUMB_WIDTH: f32 = 4.0;
pub(crate) const SCROLLBAR_THUMB_HOVER_WIDTH: f32 = 6.0;
pub(crate) const SCROLLBAR_ARROW_HEIGHT: f32 = 16.0;
pub(crate) const SCROLLBAR_MIN_THUMB_HEIGHT: f32 = 32.0;
pub(crate) const SCROLLBAR_TRACK_BG: u32 = 0xf8f8f8;
pub(crate) const SCROLLBAR_THUMB_BG: u32 = 0x8a8a8a;
pub(crate) const SCROLLBAR_THUMB_HOVER_BG: u32 = 0x707070;
pub(crate) const SCROLLBAR_THUMB_ACTIVE_BG: u32 = 0x5f5f5f;
pub(crate) const SCROLLBAR_ARROW_COLOR: u32 = 0x606060;
pub(crate) const SCROLLBAR_ARROW_HOVER_BG: u32 = 0xe8e8e8;
pub(crate) const HORIZONTAL_SCROLLBAR_LINE_DELTA: f32 = 40.0;
