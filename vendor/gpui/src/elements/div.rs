...
impl Interactivity {
    ...
    pub fn on_drag<T, W>(
        ...
        W: 'static + Render,
    {
        self.on_drag_with_external_paths(value, None, constructor);
    }

    /// Like [`Self::on_drag`], but also advertises file paths to the operating system
    /// when this drag leaves the GPUI window.
...
pub trait StatefulInteractiveElement: InteractiveElement {
    ...
    /// On drag initiation, carries the typed GPUI drag value for in-app drops and
    /// advertises `external_paths` to native operating-system drop targets.
    ...
    {
        self.interactivity()
            .on_drag_with_external_paths(value, Some(external_paths), constructor);
        self
    }
